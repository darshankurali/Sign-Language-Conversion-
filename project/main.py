...
def open_main_ui():
    ...
    bg_image = Image.open("C:/Users/darsh/majorproject/project/kashish.png")  # Replace with your image file path
    ...
    # Start the Tkinter event loop TF_ENABLE_ONEDNN_OPTScl
    root.mainloop()
